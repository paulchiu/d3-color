...
>
> This is d3-color version 2.*.*, a historical version maintained for **CommonJS backwards compatibility only**. This version includes security patches but retains CommonJS module support that was removed in version 3.0.0.
>
...
You can also download the [latest release](https://github.com/paulchiu/d3-color/releases/latest) from this repository. AMD, CommonJS, and vanilla environments are supported. In vanilla, a `d3` global is exported:

```html
<script src="https://unpkg.com/@paulchiu/d3-color-common-js/dist/d3-color-common-js.min.js"></script>
<script>
...
<a name="color" href="#color">#</a> d3.<b>color</b>(<i>specifier</i>) [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_rgb" href="#color_rgb">#</a> *color*.<b>rgb</b>() [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")

Returns the [RGB equivalent](#rgb) of this color. For RGB colors, that’s `this`.

<a name="color_copy" href="#color_copy">#</a> <i>color</i>.<b>copy</b>([<i>values</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_brighter" href="#color_brighter">#</a> *color*.<b>brighter</b>([<i>k</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_darker" href="#color_darker">#</a> *color*.<b>darker</b>([<i>k</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_displayable" href="#color_displayable">#</a> *color*.<b>displayable</b>() [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_formatHex" href="#color_formatHex">#</a> *color*.<b>formatHex</b>() [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_formatHsl" href="#color_formatHsl">#</a> *color*.<b>formatHsl</b>() [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_formatRgb" href="#color_formatRgb">#</a> *color*.<b>formatRgb</b>() [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")
...
<a name="color_toString" href="#color_toString">#</a> *color*.<b>toString</b>() [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")

An alias for [*color*.formatRgb](#color_formatRgb).

<a name="rgb" href="#rgb">#</a> d3.<b>rgb</b>(<i>r</i>, <i>g</i>, <i>b</i>[, <i>opacity</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")<br>
...
<a name="hsl" href="#hsl">#</a> d3.<b>hsl</b>(<i>h</i>, <i>s</i>, <i>l</i>[, <i>opacity</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/color.js "Source")<br>
...
<a name="lab" href="#lab">#</a> d3.<b>lab</b>(<i>l</i>, <i>a</i>, <i>b</i>[, <i>opacity</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/lab.js "Source")<br>
...
<a name="gray" href="#gray">#</a> d3.<b>gray</b>(<i>l</i>[, <i>opacity</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/lab.js "Source")<br>

Constructs a new [CIELAB](#lab) color with the specified *l* value and *a* = *b* = 0.

<a name="hcl" href="#hcl">#</a> d3.<b>hcl</b>(<i>h</i>, <i>c</i>, <i>l</i>[, <i>opacity</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/lab.js "Source")<br>
...
<a name="lch" href="#lch">#</a> d3.<b>lch</b>(<i>l</i>, <i>c</i>, <i>h</i>[, <i>opacity</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/lab.js "Source")<br>
...
<a name="cubehelix" href="#cubehelix">#</a> d3.<b>cubehelix</b>(<i>h</i>, <i>s</i>, <i>l</i>[, <i>opacity</i>]) [<>](https://github.com/paulchiu/d3-color/blob/main/src/cubehelix.js "Source")<br>
